...
public class OrderlistFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new OrderListAdapter(getContext().getApplicationContext(), orderList);
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String>
    {
        ...
        protected void onPreExecute() {
            target = "http://coamaster.dothome.co.kr/android/OrderList.php?user_id=" + user_id;
        ...
        protected void onPostExecute(String result) {
            try{
                ...
                int count = 0;
                String orderContent, orderCondi, orderDate;

                while(count < jsonArray.length())
                {

                    JSONObject object = jsonArray.getJSONObject(count);
                    orderContent = object.getString("orderContent");
                    orderCondi = object.getString("orderCondi");
                    orderDate = object.getString("orderDate");
                    Order order = new Order(orderContent, orderCondi, orderDate);
                    orderList.add(order);
